...
export type ProjectImageWhereInput = {
  ...
  image_id?: Prisma.UuidFilter<"ProjectImage"> | string
  project_id?: Prisma.UuidFilter<"ProjectImage"> | string
...
export type ProjectImageScalarWhereWithAggregatesInput = {
  ...
  image_id?: Prisma.UuidWithAggregatesFilter<"ProjectImage"> | string
  project_id?: Prisma.UuidWithAggregatesFilter<"ProjectImage"> | string
...
export type ProjectImageCreateInput = {
  ...
  alt_text?: string | null
  sort_order?: number
  project: Prisma.ProjectCreateNestedOneWithoutProject_imagesInput
}
...
export type ProjectImageUpdateInput = {
  ...
  project?: Prisma.ProjectUpdateOneRequiredWithoutProject_imagesNestedInput
}
...
export type ProjectImageOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"image_id" | "project_id" | "url" | "alt_text" | "sort_order", ExtArgs["result"]["projectImage"]>
...
export interface ProjectImageDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
   ...
   * const projectImageWithImage_idOnly = await prisma.projectImage.findMany({ select: { image_id: true } })
   * 
   */
   ...
   * })
   * 
   * // Create many ProjectImages and only return the `image_id`
   * const projectImageWithImage_idOnly = await prisma.projectImage.createManyAndReturn({
   ...
   * })
   * 
   * // Update zero or more ProjectImages and only return the `image_id`
   * const projectImageWithImage_idOnly = await prisma.projectImage.updateManyAndReturn({
   *   select: { image_id: true },
   *   where: {
   *     // ... provide filter here
   *   },
