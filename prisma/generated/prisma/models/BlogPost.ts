...
export type BlogPostWhereInput = {
  ...
  blog_id?: Prisma.UuidFilter<"BlogPost"> | string
  user_id?: Prisma.UuidFilter<"BlogPost"> | string
...
export type BlogPostScalarWhereWithAggregatesInput = {
  ...
  blog_id?: Prisma.UuidWithAggregatesFilter<"BlogPost"> | string
  user_id?: Prisma.UuidWithAggregatesFilter<"BlogPost"> | string
...
export type BlogPostCreateInput = {
  ...
  user: Prisma.UserCreateNestedOneWithoutBlog_postsInput
}
...
export type BlogPostUpdateInput = {
  blog_id?: Prisma.StringFieldUpdateOperationsInput | string
  ...
  user?: Prisma.UserUpdateOneRequiredWithoutBlog_postsNestedInput
}
...
export type BlogPostOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"blog_id" | "user_id" | "title" | "slug" | "content" | "status" | "created_at" | "updated_at", ExtArgs["result"]["blogPost"]>
...
export interface BlogPostDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
   ...
   * const blogPostWithBlog_idOnly = await prisma.blogPost.findMany({ select: { blog_id: true } })
   * 
   */
   ...
   * })
   * 
   * // Create many BlogPosts and only return the `blog_id`
   * const blogPostWithBlog_idOnly = await prisma.blogPost.createManyAndReturn({
   *   select: { blog_id: true },
   *   data: [
   *     // ... provide data here
   *   ]
   ...
   * })
   * 
   * // Update zero or more BlogPosts and only return the `blog_id`
   * const blogPostWithBlog_idOnly = await prisma.blogPost.updateManyAndReturn({
   *   select: { blog_id: true },
   *   where: {
   *     // ... provide filter here
   *   },
...
export interface BlogPostFieldRefs {
  readonly blog_id: Prisma.FieldRef<"BlogPost", 'String'>
  readonly user_id: Prisma.FieldRef<"BlogPost", 'String'>
