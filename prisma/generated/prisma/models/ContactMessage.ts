...
export type ContactMessageWhereInput = {
  ...
  message_id?: Prisma.UuidFilter<"ContactMessage"> | string
...
export type ContactMessageScalarWhereWithAggregatesInput = {
  ...
  message_id?: Prisma.UuidWithAggregatesFilter<"ContactMessage"> | string
...
export type ContactMessageOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"message_id" | "name" | "email" | "message" | "created_at", ExtArgs["result"]["contactMessage"]>
...
export interface ContactMessageDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
   ...
   * const contactMessageWithMessage_idOnly = await prisma.contactMessage.findMany({ select: { message_id: true } })
   * 
   */
   ...
   * })
   * 
   * // Create many ContactMessages and only return the `message_id`
   * const contactMessageWithMessage_idOnly = await prisma.contactMessage.createManyAndReturn({
   ...
   * })
   * 
   * // Update zero or more ContactMessages and only return the `message_id`
   * const contactMessageWithMessage_idOnly = await prisma.contactMessage.updateManyAndReturn({
   *   select: { message_id: true },
   *   where: {
   *     // ... provide filter here
   *   },
...
export interface ContactMessageFieldRefs {
  readonly message_id: Prisma.FieldRef<"ContactMessage", 'String'>
